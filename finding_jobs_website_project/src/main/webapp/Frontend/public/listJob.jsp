		                            ...
		                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
		                                <div class="one-third mb-4 mb-md-0" onclick="window.location.href='${pageContext.request.contextPath}/recruitment/detail?id=${recruitment.id}'">
		                                    <div class="job-post-item-header align-items-center">
		                                        ...
		                                        <h2 class="mr-3 text-black"><a href="${pageContext.request.contextPath}/recruitment/detail?id=${recruitment.id}&company_id1=${company_id}">${recruitment.title}</a></h2>
		
		                                    </div>
		                                    <div class="job-post-item-body d-block d-md-flex">
											    <div class="mr-3"><span class="icon-layers"></span> Company ID: ${recruitment.company_id}</div>
