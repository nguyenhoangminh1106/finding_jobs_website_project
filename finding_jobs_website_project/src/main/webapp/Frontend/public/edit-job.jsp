      ...
      <div class="row no-gutters slider-text align-items-end justify-content-start">
        <div class="col-md-12 text-center mb-5">
          <p class="breadcrumbs mb-0">
            <span class="mr-3">
              <a href="${pageContext.request.contextPath}/">Trang chủ <i class="ion-ios-arrow-forward"></i></a>
            </span> Cập nhập<span></span>
          </p>
      ...
      <div class="row">
        <div class="col-md-7">
          ...
          <div class="custom-breadcrumbs">
            <a href="${pageContext.request.contextPath}/user/list-post">Danh sách</a> <span class="mx-2 slash">/</span>
...
<c:if test="${user.role_id == 2}">
  <section class="site-section">
	  <div class="container">
	    <form action="${pageContext.request.contextPath}/recruitment/edit" method="get">
	      	<input type="hidden" class="form-control" id="job-location"  name="id" value="${recruitment.id}">
			<input type="hidden" class="form-control" id="job-location"  name="created_at" value="${recruitment.created_at}">
			  ...
			  <div class="col-lg-12">
			    <div class="p-4 p-md-5 border rounded">
			      ...
			      <div class="form-group">
			        ...
			        <input type="text" class="form-control" id="title" name="title" required value="${recruitment.title}">
			      </div>
			      <div class="form-group">
			        <label for="description">Mô tả công việc</label>
			        <textarea name="description" class="form-control" id="description">${recruitment.description}</textarea>
			      </div>
			      <div class="form-group">
			        <label for="experience">Kinh nghiệm</label>
			        <input type="text" class="form-control" id="experience" name="experience" value="${recruitment.experience}">
			      </div>
			      <div class="form-group">
			      ...
			      <div class="form-group">
			        ...
			        <select class="form-control" name="category_id" aria-label="Default select example" required>
			          <option value="${recruitment.category_id}">Please choose ...</option>
