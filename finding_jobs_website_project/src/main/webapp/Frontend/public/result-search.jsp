	            ...
	            <div class="col-lg-12 pr-lg-5">
	                <div class="row">
	                	<c:if test="${numberOfPages > 0}">
						    <c:forEach items="${list}" var="recruitment" varStatus="index">
						        <div class="col-md-12">
								    <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
								        <div class="one-third mb-4 mb-md-0" onclick="window.location.href='${pageContext.request.contextPath}/recruitment/detail?id=${recruitment.id}&company_id1=${recruitment.company_id}'">
								            <div class="job-post-item-header align-items-center">
								                <span class="subadge"><c:out value="${recruitment.type}"/></span>
								                <h2 class="mr-3 text-black"><a href='${pageContext.request.contextPath}/recruitment/detail?id=${recruitment.id}&company_id1=${recruitment.company_id}'><c:out value="${recruitment.title}"/></a></h2>
								            </div>
								            <div class="job-post-item-body d-block d-md-flex">
								                <div class="mr-3"><span class="icon-layers"></span> <a href="${pageContext.request.contextPath}/recruitment/detail?id=${recruitment.id}&company_id1=${recruitment.company_id}">Company ID: <c:out value="${recruitment.company_id}"/></a></div>
								        ...
								        <div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
								        	<c:if test="${user.role_id == 1 }">
					                        	<c:if test="${isSaveList.get(index.index) == false}">
												     <form action="${pageContext.request.contextPath}/user/saveJob">
												...
												<c:if test="${isSaveList.get(index.index) == true}">
								            	...
								            	<a data-toggle="modal" data-target='#exampleModal<c:out value="${recruitment.id}"/>' class="btn btn-primary m-1">Apply Job</a>
					                        </c:if>								            
								        </div>
								        ...
								        <div class="modal-content">
								            ...
								            <form method="post" action="${pageContext.request.contextPath}/user/apply-job">
								                ...
								                <div class="modal-body">
								                    <div class="row">
								                        <div class="col-12">
								                            <select name="send_cv_option" id='choose${recruitment.id}' onchange='choosed(${recruitment.id})' class="form-control" aria-label="Default select example">
								                        ...
								                        <div id='loai2${recruitment.id}' style="display:none" class="col-12">
								                            ...
								                            <input name="file" type="file" class="form-control" id='fileUpload${recruitment.id}' name="file">
	                        ...
	                        <div class="block-27">
							    <ul>
							        <c:forEach begin="1" end="${numberOfPages }" varStatus="state">
							            <li class="${numberPage == state.index ? 'active' : ''}"><a href="${pageContext.request.contextPath}${requestMapping }?page=${state.index}&keySearch=${keySearch}">${state.index}</a></li>
							        </c:forEach>
							    </ul>
							</div>
